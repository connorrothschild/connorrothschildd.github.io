...
{% highlight text %}
## Error: `path` does not exist: 'biblebabynames.xlsx'
{% endhighlight %}
...
{% highlight text %}
## Error in eval(lhs, parent, parent): object 'biblenames' not found
{% endhighlight %}
...
{% highlight text %}
## Error in rbind(boybible, girlbible): object 'boybible' not found
{% endhighlight %}
...
{% highlight text %}
## Error in name %in% biblenamesbind$names: object 'biblenamesbind' not found
{% endhighlight %}
...
{% highlight text %}
## Error: object 'biblepercent' not found
{% endhighlight %}
...
{% highlight text %}
## Error in rank(x, ties.method = "min", na.last = "keep"): object 'biblepercent' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(lhs, parent, parent): object 'malebabynames' not found
{% endhighlight %}
...
{% highlight text %}
## Error in animate(maleanimation, fps = 25, duration = 25, width = 800, : object 'maleanimation' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(lhs, parent, parent): object 'femalebabynames' not found
{% endhighlight %}
...
{% highlight text %}
## Error in animate(femaleanimation, fps = 25, duration = 25, width = 800, : object 'femaleanimation' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(lhs, parent, parent): object 'babynamesrank' not found
{% endhighlight %}
...
{% highlight text %}
## Error in animate(babyanimation, fps = 25, duration = 25, width = 800, : object 'babyanimation' not found
{% endhighlight %}
