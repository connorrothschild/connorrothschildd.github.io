...
```{r, include=FALSE}
conflicted::conflict_prefer("scale_colour_discrete", "tpltheme")
conflicted::conflict_prefer("scale_fill_discrete", "tpltheme")
conflicted::conflict_prefer("view_palette", "tpltheme")
```
